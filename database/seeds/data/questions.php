...
return [
    ...
    [
        ...
        'text' => 'В компании начинается спор. Твоя обычная роль?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        ...
        'text' => 'У тебя сорвался план на день. Как реагируешь?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        ...
        'text' => 'Что тебя сильнее всего раздражает в людях?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q07_work_role',
        'text' => 'В работе или деле тебе ближе роль…',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q10_support',
        'text' => 'Что ты делаешь, когда видишь, что человек расстроен?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q11_friends',
        'text' => 'Что для тебя естественнее в компании друзей?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q12_risk',
        'text' => 'Как ты реагируешь на риск?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q15_new_ideas',
        'text' => 'Как ты обычно относишься к новым идеям?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        ...
        'text' => 'Что ты делаешь, если тебя недооценили?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        ...
        'text' => 'Что тебе сложнее всего терпеть?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q19_adventure',
        'text' => 'Тебе предлагают внезапную авантюру. Что отвечаешь?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        ...
        'text' => 'Какое описание тебе ближе?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q21_loneliness',
        'text' => 'Как ты обычно относишься к одиночеству?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q22_trust',
        'text' => 'Как ты начинаешь доверять людям?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q23_attention',
        'text' => 'Что ты чувствуешь, когда оказываешься в центре внимания?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q24_care',
        'text' => 'Как ты заботишься о близких?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q25_pressure',
        'text' => 'На тебя давят и требуют срочно решить вопрос. Что происходит?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q26_status',
        'text' => 'Как ты относишься к статусу и признанию?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        'code' => 'q27_planning',
        'text' => 'Как у тебя с планами и режимом?',
        'answers' => [
            [
                'code' => 'a',
    ...
    [
        ...
        'text' => 'Если твоя компания или команда попала в сложную ситуацию, ты…',
        'answers' => [
            [
                'code' => 'a',
